...
class GitHubPagesStaticModeTests(unittest.TestCase):
    ...
    def test_static_mode_hides_local_scoring_tags_and_category_surfaces(self):
        ...
        self.assertIn('[data-static-site]:not([data-private-unlocked="true"]) .title-score', css)
        self.assertIn('[data-static-site]:not([data-private-unlocked="true"]) .level-row', css)
        self.assertIn('[data-static-site]:not([data-private-unlocked="true"]) .tag-row', css)
        self.assertIn('[data-static-site]:not([data-private-unlocked="true"]) .side-section[data-static-hide="true"]', css)
